...
public class ProdutoResponseDTO {
	...
	public static ProdutoResponseDTO converterParaProdutoDTO(Produto produto) {
		return new ProdutoResponseDTO(produto.getCodigo(), produto.getObservacao(), produto.getQuantidade(),
				produto.getPrecoVenda(), produto.getPrecoCusto(), produto.getDescricao(),
