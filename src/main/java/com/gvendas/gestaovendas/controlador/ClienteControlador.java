...
public class ClienteControlador {
	...
	@ApiOperation(value = "Listar por Código", nickname = "buscarClientePorCodigo")
	@GetMapping("/{codigo}")
	...
	public ResponseEntity<ClienteResponseDTO> atualizar(@PathVariable Long codigo,@Valid @RequestBody ClienteRequestDTO clienteDto){
		Cliente clienteAtualizado = clienteServico.atualizar(codigo, clienteDto.converterParaEntidade());
